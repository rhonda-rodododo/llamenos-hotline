...
La configuracion de WebRTC con Asterisk es mas compleja que con proveedores en la nube. Consulta la guia de [Llamadas WebRTC en el Navegador](/docs/webrtc-calling) para mas detalles.
