...
| **strfry** | Nostr relay for real-time events |
| **Caddy** | Reverse proxy + automatic TLS (Docker Compose) |
| **Authentik** | Identity provider — SSO, invite-based onboarding, MFA |
...
- **Asterisk** — for self-hosted SIP telephony (see [Asterisk setup](/docs/deploy/providers/asterisk))
- **Signal bridge** — for Signal messaging (see [Signal setup](/docs/deploy/providers/signal))
...
- [Getting Started](/docs/deploy/) — quick start with Docker
