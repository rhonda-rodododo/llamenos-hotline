...
The ARI bridge is a small service that translates between Llamenos webhooks and ARI events. It runs alongside Asterisk and connects to both the ARI WebSocket and your Llamenos server.
...
WebRTC setup with Asterisk is more involved than with cloud providers. See the [WebRTC Browser Calling](/docs/deploy/providers/webrtc) guide for details.
...
- **Bridge not connecting**: Check that the ARI bridge can reach both the Asterisk ARI endpoint and your Llamenos server URL.
