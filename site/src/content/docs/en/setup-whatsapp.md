...
Meta will send a GET request to verify the webhook. Your Worker will respond with the challenge if the verify token matches.
...
- Messages are stored in Llamenos after receipt from the webhook
