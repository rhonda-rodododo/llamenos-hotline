...
Thay `your-domain.com` bằng URL Llamenos server thực tế của bạn.
...
3. Đặt **Voice Request URL** thành `https://your-domain.com/telephony/webrtc-incoming`
...
Xem [Gọi qua trình duyệt WebRTC](/docs/webrtc-calling) để biết cách thiết lập cho tình nguyện viên và xử lý sự cố.
