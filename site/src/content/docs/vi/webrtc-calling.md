...
2. Tạo **TwiML/LaML Application** với Voice URL đặt thành `https://your-domain.com/telephony/webrtc-incoming`
...
Xem [hướng dẫn thiết lập Asterisk](/docs/setup-asterisk) để biết chi tiết đầy đủ.
