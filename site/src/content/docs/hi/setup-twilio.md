...
`your-domain.com` को अपने वास्तविक Llamenos server URL से बदलें।
...
3. **Voice Request URL** को `https://your-domain.com/telephony/webrtc-incoming` पर सेट करें
...
वॉलंटियर सेटअप और समस्या निवारण के लिए [WebRTC ब्राउज़र कॉलिंग](/docs/webrtc-calling) देखें।
