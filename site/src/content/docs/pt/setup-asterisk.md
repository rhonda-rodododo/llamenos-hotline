...
A configuracao WebRTC com Asterisk e mais complexa do que com provedores cloud. Consulte o guia [Chamadas WebRTC no navegador](/docs/webrtc-calling) para detalhes.
