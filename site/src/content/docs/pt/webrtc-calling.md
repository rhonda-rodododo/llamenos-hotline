...
2. Crie um **aplicativo TwiML/LaML** com o Voice URL definido como `https://your-domain.com/telephony/webrtc-incoming`
...
Consulte o [guia de configuracao do Asterisk](/docs/setup-asterisk) para todos os detalhes.
