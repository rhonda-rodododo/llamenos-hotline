...
La configuration WebRTC avec Asterisk est plus complexe qu'avec les fournisseurs cloud. Consultez le guide [Appels WebRTC dans le navigateur](/docs/webrtc-calling) pour plus de details.
