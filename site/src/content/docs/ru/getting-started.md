...
- Учётная запись провайдера телефонии — [Twilio](https://www.twilio.com) проще всего для начала, но Llamenos также поддерживает [SignalWire](/docs/setup-signalwire), [Vonage](/docs/setup-vonage), [Plivo](/docs/setup-plivo) и [самостоятельно размещённый Asterisk](/docs/setup-asterisk). Для помощи в выборе смотрите [сравнение провайдеров телефонии](/docs/telephony-providers).
- Git
...
> **Примечание**: Вы также можете полностью настроить провайдера телефонии через интерфейс настроек администратора вместо использования переменных окружения. Это обязательно для провайдеров, отличных от Twilio. Смотрите [руководство по настройке вашего провайдера](/docs/telephony-providers).
...
Инструкции по настройке вебхуков для конкретных провайдеров смотрите в: [Twilio](/docs/setup-twilio), [SignalWire](/docs/setup-signalwire), [Vonage](/docs/setup-vonage), [Plivo](/docs/setup-plivo) или [Asterisk](/docs/setup-asterisk).
...
- [Провайдеры телефонии](/docs/telephony-providers) — сравнение провайдеров и переход с Twilio при необходимости
