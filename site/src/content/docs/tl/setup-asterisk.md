...
Ang WebRTC setup kasama ang Asterisk ay mas komplikado kaysa sa mga cloud provider. Tingnan ang gabay sa [WebRTC Browser Calling](/docs/webrtc-calling) para sa mga detalye.
