...
Die WebRTC-Einrichtung mit Asterisk ist aufwaendiger als bei Cloud-Anbietern. Siehe den Leitfaden [WebRTC-Browseranrufe](/docs/webrtc-calling) fuer Details.
