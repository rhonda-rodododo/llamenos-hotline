...
2. Erstellen Sie eine **TwiML/LaML-Anwendung** mit der Voice URL auf `https://your-domain.com/telephony/webrtc-incoming`
...
Siehe den [Asterisk-Einrichtungsleitfaden](/docs/setup-asterisk) fuer alle Details.
