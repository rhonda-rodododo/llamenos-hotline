...
test.describe('Voicemail UI', () => {
  ...
  // TestAdapter doesn't fully wire up the call flow (no active call record created),
  // so the voicemail-recording handler can't resolve the hub for the call history entry.
  // Needs TestAdapter to create active call records on /incoming webhook.
  test.fixme(
