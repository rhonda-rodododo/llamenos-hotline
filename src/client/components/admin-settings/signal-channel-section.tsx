      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="signal-bridge-url">
            {t('signal.bridgeUrl', { defaultValue: 'Bridge URL' })}
          </Label>
          <Input
        ...
        <div className="space-y-2">
          <Label htmlFor="signal-api-key">
            {t('signal.bridgeApiKey', { defaultValue: 'Bridge API Key' })}
          </Label>
          <Input
            id="signal-api-key"
            type="password"
        ...
        <div className="space-y-2">
          <Label htmlFor="signal-webhook-secret">
            {t('signal.webhookSecret', { defaultValue: 'Webhook Secret' })}
          </Label>
          <Input
        ...
        <div className="space-y-2">
          <Label htmlFor="signal-registered-number">
            {t('signal.registeredNumber', { defaultValue: 'Registered Number' })}
          </Label>
          <Input
        ...
        <div className="space-y-2">
          <Label htmlFor="signal-auto-response">
            {t('signal.autoResponse', { defaultValue: 'Auto-Response' })}
          </Label>
          <Input
