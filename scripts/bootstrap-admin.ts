...
console.log('1. Add to .env (local dev or Docker deployment):')
...
console.log('2. The admin logs in with the IDENTITY nsec.')
console.log('3. The admin imports the DECRYPTION nsec to decrypt notes.')
