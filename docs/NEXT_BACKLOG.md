...
- [ ] **[Epic 362: Permission Granularity Overhaul](epics/epic-362-permission-granularity.md)** — Fix 10 categories: 4 phantom permissions, 3 overloaded permissions, 8 unguarded endpoints, 3 cross-domain borrowing, 2 missing role assignments, 1 data leakage. Expand permission-matrix BDD tests to cover all endpoints.
